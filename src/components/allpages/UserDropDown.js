        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-body">
              ...
              <Link to={`/learnProfile/${user.id}`}><p onClick={() => setTimeout(() => { window.location.reload() }, 1000)} className='btn btn-secondary form-control' data-bs-dismiss="modal">My Profile</p></Link>
